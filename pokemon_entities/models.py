...
class Pokemon(models.Model):
    ...
    photo = models.ImageField(upload_to='', blank=True, verbose_name='Изображение')
...
class PokemonEntity(models.Model):
    pokemon = models.ForeignKey(Pokemon, on_delete=models.CASCADE, blank=True, verbose_name='Вид покемона')
    latitude = models.FloatField(verbose_name='Координаты широты')
    longitude = models.FloatField(verbose_name='Координаты долготы')
    appeared_at = models.DateTimeField(verbose_name='Появиляется в')
